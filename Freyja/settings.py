...
SECRET_KEY = os.environ['FREYJA_SECRET_KEY']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'Athletics',
        'HOST': '82.221.94.225',
        'USER': os.environ['FREYJA_DB_USER'],
        'PASSWORD': os.environ['FREYJA_DB_PASSWORD'],

        'OPTIONS': {
            #'driver': '/opt/microsoft/msodbcsql17/lib64/libmsodbcsql-17.4.so.2.1',
            'driver': os.path.join(BASE_DIR, 'drv/msodbcsql17/lib64/libmsodbcsql-17.5.so.1.1'), # The driver is in the GIT repository
            'host_is_server': True,
        },
    },
}
