<template>
  <div>
    ...
    <div v-if="!loading">
      <p>Hér sjást bestu afrek ársins. Smelltu á grein í listanum til að sjá top 100 listan fyrir árið eða smelltu á nafn til að sjá upplýsingar um keppandann.</p>
      <!---->
      <h3>Konur</h3>
